...
public class NhanVienGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel25.setIcon(new javax.swing.ImageIcon(getClass().getResource("employee.png"))); // NOI18N
        ...
        btnRefreshTTMB.setIcon(new javax.swing.ImageIcon(getClass().getResource("rotation.png"))); // NOI18N
        ...
        btnRefreshQLCD.setIcon(new javax.swing.ImageIcon(getClass().getResource("rotation.png"))); // NOI18N
        ...
        tblQuanLyCuDan.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã cư dân", "Tên cư dân", "Ngày sinh", "Giới tính", "SĐT", "Số CCCD", "Quê quán"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.Integer.class, java.lang.String.class
        ...
        cmbGioitinh1.setEditor(new BasicComboBoxEditor());
        ...
        btnInhopdong.setIcon(new javax.swing.ImageIcon(getClass().getResource("printer.png"))); // NOI18N
        ...
        btTim_CanHo.setIcon(new javax.swing.ImageIcon(getClass().getResource("find.png"))); // NOI18N
        ...
        cbbDienTich.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Từ 40m² - 60m²", "Từ 60m² - 80mm²", "Trên 80m²" }));

        cbbGia.setForeground(new java.awt.Color(0, 0, 204));
        cbbGia.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Dưới 150.000$", "Từ 150.000$ - 300.000$", "Trên 300.000$", " " }));
        ...
        btnRefreshTTCH.setIcon(new javax.swing.ImageIcon(getClass().getResource("rotation.png"))); // NOI18N
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        try {
            if (txtMacudan.getText().length() == 0) {
                ...
                JOptionPane.showMessageDialog(null, "Số CCCD trống.", "Error", JOptionPane.ERROR_MESSAGE);
                ...
                JOptionPane.showMessageDialog(null, "Số CCCD gồm 9 hoặc 12 số.", "Error", JOptionPane.ERROR_MESSAGE);
            } else {
    ...
    private void btnInhopdongActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInhopdongActionPerformed
        try {
            if (txtMacanho1.getText().equals("")) {
                ...
                JOptionPane.showMessageDialog(null, "Nhập số căn cước công dân.", "Error", JOptionPane.ERROR_MESSAGE);
            } else if (!RegexExpression.checkID(txtScmt.getText().trim())) {
                JOptionPane.showMessageDialog(null, "Số căn cước công dân gồm 9 hoặc 12 số.", "Error", JOptionPane.ERROR_MESSAGE);
                ...
                Desktop.getDesktop().open(new File("C:\\Users\\Admin\\Documents\\Hợp đồng mua chung cư Central Park.docx"));
            }
